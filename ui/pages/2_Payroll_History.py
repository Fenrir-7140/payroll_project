...
def run_payroll_history():
    ...
    try:
        ...
        selected_emp_name = st.selectbox("Select Employee to View History", list(employee_options.keys()))
            ...
            formatted_data = [
                {
                    ...
                    "Gross Salary ($)": f"${record.total_gross:,.2f}",
                    "Net Salary ($)": f"${record.total_net:,.2f}"
                }
